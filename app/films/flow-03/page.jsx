...
export default function filmsLanding() {
    ...
    return (
        <>
            <Header />
            <LandingWrap>
                <HeroSection href={'/films/flow-03/choose-film'}/>
                <FilmsInfo />
                <Protective href={'/films/flow-03/choose-film'}/>
                <Realiability />
                <AdvantageSection 
                    title={'DU SCHÄTZT HOCHWERTIGE TECHNIK?'}
                    bgImage={"/images/advantage_bg_5.png"}
                    href={'/films/flow-03/choose-film'}/>
                <AdvantageSection 
                ...
                <Faq />
                <Feedback />
                <Explanation href={'/films/flow-03/choose-film'} flow={'films/flow-03'}/>
            </LandingWrap>
            <ScrollToTop />
        </>
    )
