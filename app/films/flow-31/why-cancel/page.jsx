...
export default function WhyCanceled() {
  ...
  const handleSubmit = async () => {
    const finalAnswer =
      selectedOption === "custom" ? customInput : selectedOption;
  ...
  return (
    <QuizWrap>
      <h2 className={styles.title}>
        Warum haben Sie sich gegen den Kauf entschieden?
      </h2>
      ...
      <TranspBtn marginTop="20px" onClick={handleSubmit}>
        ANTWORT SENDEN
      </TranspBtn>
      <WhiteBtn marginTop="20px" onClick={goToBuy}>
        ZUM KAUF ZURÜCKKEHREN
      </WhiteBtn>
    </QuizWrap>
  );
}
