        ...
        <>
            ...
            <LandingWrap>
                <AdvantageSection 
                        ...
                        href={'/films/flow-08/choose-film'}/>
                <HeroSection href={'/films/flow-08/choose-film'}/>
                <FilmsInfo />
                <Protective href={'/films/flow-08/choose-film'}/>
                <Realiability />
                <Feedback />
                <Faq />
                <Explanation href={'/films/flow-08/choose-film'} flow={'films/flow-08'}/>
            </LandingWrap>
            <ScrollToTop />
        </>
    )
