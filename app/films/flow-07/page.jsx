...
export default function filmsLanding() {
    ...
    return (
        <>
            <Header />
            <LandingWrap>
                <HeroSection href={'/films/flow-07/choose-film'}/>
                <AdvantageSection 
                    title={<>DU BIST<br /> GESCHÄFTS&shy;INHABER?</>}
                    bgImage={"/images/advantage_bg_4.png"}
                    href={'/films/flow-07/choose-film'}/>                <FilmsInfo />
                <Protective href={'/films/flow-07/choose-film'}/>
                <Realiability />
                <Feedback />
                <Faq />
                <Explanation href={'/films/flow-07/choose-film'} flow={'films/flow-07'}/>
            </LandingWrap>
            <ScrollToTop />
        </>
    )
