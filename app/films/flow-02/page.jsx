        ...
        <>
            ...
            <LandingWrap>
                <AdvantageSection 
                        ...
                        href={'/films/flow-02/choose-film'}/>
                <HeroSection href={'/films/flow-02/choose-film'}/>
                <FilmsInfo />
                <Protective href={'/films/flow-02/choose-film'}/>
                <Realiability />
                <Feedback />
                <Faq />
                <Explanation href={'/films/flow-02/choose-film'} flow={'films/flow-02'}/>
            </LandingWrap>
            <ScrollToTop />
        </>
    )
