        ...
        <>
            ...
            <LandingWrap>
                <AdvantageSection 
                    ...
                    href={'/films/flow-09/choose-film'}/>
                <AdvantageSection 
                    title={'DU HAST VERSPIELTE HAUSTIERE?'}
                    bgImage={"/images/advantage_bg_2.png"}
                    href={'/films/flow-09/choose-film'}/>

                <HeroSection href={'/films/flow-09/choose-film'}/>
                <FilmsInfo />
                <Protective href={'/films/flow-09/choose-film'}/>
                <Realiability />
                <Feedback />
                <Faq />
                <Explanation href={'/films/flow-09/choose-film'} flow={'films/flow-09'}/>
            </LandingWrap>
            <ScrollToTop />
        </>
    )
