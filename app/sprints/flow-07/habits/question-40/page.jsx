...
export default function question40() {
  ...
  const goToNextStep = async (answer) => {
    await nextStep({
      step: 6,
      type: "question",
      question: "What kind of habit do you want to build right now?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/habits/question-50`);
  };
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          What kind of habit do you want to build right now?
        </p>
