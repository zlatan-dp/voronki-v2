...
export default function question40() {
  ...
  const goToNextStep = async (answer) => {
    await nextStep({
      step: 6,
      type: "question",
      question: "When do you need focus the most?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/focus/question-50`);
  };
  ...
  return (
    <Container>
      ...
      />
      <QuestionWrap>
        <p className={styles.questionText}>When do you need focus the most?</p>
