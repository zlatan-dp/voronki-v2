...
export default function question60() {
  ...
  const goToNextStep = async (answer) => {
    await nextStep({
      step: 9,
      type: "question",
      question: "How do you usually start a task?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/focus/question-70`);
  };
  ...
  return (
    <Container>
      ...
      />
      <QuestionWrap>
        <p className={styles.questionText}>How do you usually start a task?</p>
