...
export default function question30() {
  ...
  const goToNextStep = async (answer) => {
    await nextStep({
      step: 5,
      type: "question",
      question: "What feels hardest to manage day to day right now?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/universal/question-40`);
  };
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          What feels hardest to manage day to day right now?
        </p>
