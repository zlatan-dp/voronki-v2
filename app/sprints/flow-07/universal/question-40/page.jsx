...
export default function question40() {
  ...
  const goToNextStep = async (answer) => {
    await nextStep({
      step: 6,
      type: "question",
      question: "What usually starts the “downward spiral” for you?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/universal/question-50`);
  };
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          What usually starts the “downward spiral” for you?
        </p>
