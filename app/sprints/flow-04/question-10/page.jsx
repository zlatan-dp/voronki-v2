...
export default function question10() {
  ...
  const goToNextStep = async (answer, points) => {
    saveQuizAnswer("question1", points);

    await nextStep({
      step: 2,
      type: "question",
      question: "How often do you still feel tired after resting or sleeping? ",
      answer: answer || "next",
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          How often do you still feel tired after resting or sleeping? 
        </p>
