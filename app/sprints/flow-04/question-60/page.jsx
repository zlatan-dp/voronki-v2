...
export default function question60() {
  ...
  const goToNextStep = async (answer, points) => {
    saveQuizAnswer("question6", points);

    await nextStep({
      step: 7,
      type: "question",
      question:
        "Do you find it hard to regain your usual energy after illness or stress? ",
      answer: answer || "next",
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          Do you find it hard to regain your usual energy after illness or
          stress? 
        </p>
