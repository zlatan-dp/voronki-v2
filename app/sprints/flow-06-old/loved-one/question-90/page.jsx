...
export default function question90() {
  ...
  const goToNextStep = async (answer, points) => {
    ...
    await nextStep({
      step: 14,
      type: "question",
      question: "How often do they say “nothing will change anyway”?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/loved-one/question-100`);
  };
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          How often do they say “nothing will change anyway”?
        </p>
