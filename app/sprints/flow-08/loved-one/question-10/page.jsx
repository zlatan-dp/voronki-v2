...
export default function question10() {
  ...
  const goToNextStep = async (answer, points) => {
    ...
    await nextStep({
      step: 2,
      type: "question",
      question: "How often does your loved one wake up feeling unrested?",
      answer: answer || "next",
      time: await getCurrentTime(),
    });

    router.push(`/sprints/${currentFlow}/loved-one/question-20`);
  };
    ...
    <Container>
      ...
      <QuestionWrap>
        <p className={styles.questionText}>
          How often does your loved one wake up feeling unrested?
        </p>
