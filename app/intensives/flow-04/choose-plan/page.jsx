...
export default function choosePlan() {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={`${styles.planWrap} ${styles.dark}`}>
        <div className={styles.titleWrap}>
          <h3 className={styles.blockWhiteTitle}>Choose your plan</h3>
        </div>
        ...
        {currentPlan && timerActive && (
          <p className={styles.subscriptionTextGray}>
            Discounted price applies to your first subscription. Your
            subscription will automatically renew at full price of{" "}
            <span className={styles.bold}>
              {`${currentPlan.currency}${currentPlan.totalPrice}`}
